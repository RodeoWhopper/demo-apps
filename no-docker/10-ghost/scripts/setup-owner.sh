...
# Env overrides: GHOST_URL, GHOST_OWNER_NAME, GHOST_OWNER_EMAIL, GHOST_OWNER_PASSWORD
set -euo pipefail
cd "$(dirname "$0")/.."

BASE="${GHOST_URL:-http://localhost:8010}"; BASE="${BASE%/}"
OWNER_NAME="${GHOST_OWNER_NAME:-Sığınak Editörü}"
OWNER_EMAIL="${GHOST_OWNER_EMAIL:-owner@siginak.dev}"
OWNER_PASS="${GHOST_OWNER_PASSWORD:-Owner123!!}"
SITE_TITLE="Sığınak"
